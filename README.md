...
| `tfx destroy` | destroy plan 생성 + y/n 확인 후 `terraform apply tfdestroyplan` (`-auto-approve` 거부) |
...
bb tfx session 15    # 현재 AWS 계정 확인 → 15분 세션 시작
bb tfx apply         # 세션 유효 + 계정 일치 + y/n 확인 후 tfplan apply
bb tfx destroy       # destroy plan 생성 + y/n 확인 후 tfdestroyplan apply
